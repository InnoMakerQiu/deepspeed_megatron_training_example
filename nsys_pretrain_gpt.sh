...
data_path="codeparrot_text_document"
...
if [ ! -f "$vocab_path" ]; then
    wget https://s3.amazonaws.com/models.huggingface.co/bert2
    gpt2-vocab.json
fi
...
deepspeed ../../pretrain_gpt.py ${megatron_options} ${data_options} ${deepspeed_options}